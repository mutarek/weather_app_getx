                      ...
                      if (snapshot.hasData) {
                        ...
                        return SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              date.text.color(theme.primaryColor).make(),
                              "${data.name}"
                                  .text
                                  .uppercase
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  "next_7_days".tr.text.semiBold.size(16).color(theme.primaryColor).make(),
                                  TextButton(onPressed: () {}, child: "view_all".tr.text.make()),
                                ],
                              ),
                              ListView.builder(
